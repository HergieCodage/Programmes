...
clear
echo "rp!character create" $reponse1
echo
...
echo
echo
echo "rp!character attribute set force" $FOR2 $reponse1
echo "rp!character attribute set agilité" $AGI2 $reponse1
echo "rp!character attribute set intelligence" $INT2 $reponse1
echo "rp!character attribute set apparence" $APP2 $reponse1
echo "rp!character attribute set endurance" $END2 $reponse1
echo "rp!character attribute set mentalité" $MEN2 $reponse1
echo
echo "rp!givemoney 100" $reponse1
echo 
echo "rp!c" $reponse1
echo "rp!character attributes" $reponse1
echo
echo "rp!bank" $reponse1
echo
